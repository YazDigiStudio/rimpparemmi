...
const copy = {
    ...
    submit: "Liity",
    success: "Kiitos liittymisestä! Tarkista sähköpostisi – vahvistusviestin saapuminen saattaa kestää muutaman minuutin.",
  ...
  en: {
    ...
    submit: "Subscribe",
    success: "Thank you for joining! Please check your email — the confirmation may take a few minutes.",
